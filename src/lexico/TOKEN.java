...
public class TOKEN
{
    ...
    public static final String TOKEN_MAIORI  = "MAIOR_Igual";
    public static final String TOKEN_MENORI = "MENOR_Igual";
    public static final String TOKEN_IGUAL = "IGUAL ";
    public static final String TOKEN_IGUALI = "IGUAL_IGUAL";
    public static final String TOKEN_PI = "PONTO_INTERROGACAO";
    ...
    public static final String TOKEN_MODI = "MODULO_IGUAL";
    public static final String TOKEN_CIR  = "CIRCUNFLEXO";
    ...
    public static final String TOKEN_APER = "ATRIBUICAO_MODULO";
